...
const Features = () => {
  return (
		<motion.div
			...
			className="features-wrapper bg-slate-900 object-cover lg:bg-slate-900 overflow-auto xllll:overflow-hidden w-screen xll:h-screen h-screen pt-48 relative z-10">
			...
			<div className="left-shape absolute left-0 bottom-0 -z-10">
				<img src={leftPng} alt="" />
			</div>
			<div className="right-shape absolute right-0 bottom-0 -z-10">
